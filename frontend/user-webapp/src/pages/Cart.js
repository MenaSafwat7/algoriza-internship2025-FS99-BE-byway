...
import { Trash2, ShoppingCart, ArrowLeft, Plus, Minus, CreditCard, Shield, Clock } from 'lucide-react';
      ...
      <div className="min-h-screen bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <Link to="/courses" className="px-6 py-3 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition-colors">
              Browse Courses
            </Link>
          </div>
        </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-6">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <Link
                  to="/checkout"
                  className="w-full bg-gray-800 text-white text-center block py-3 px-4 rounded-lg hover:bg-gray-700 transition-colors mb-4"
                >
                  Proceed to Checkout
                </Link>
